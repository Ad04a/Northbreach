...
void AMenuHUDBase::BeginPlay()
{
	...
	JoinWidget->OnRegisterClicked.BindDynamic(GameInstance, &UNorthbreachGameInstance::Register);
	JoinWidget->OnLoginClicked.BindDynamic(GameInstance, &UNorthbreachGameInstance::Login);
	JoinWidget->OnResetClicked.BindDynamic(GameInstance, &UNorthbreachGameInstance::Reset);

	GameInstance->OnPlayFabError.AddDynamic(JoinWidget, &UJoinWidgetBase::RecieveErrorMessage);
	GameInstance->OnSuccessfulRegister.AddDynamic(JoinWidget, &UJoinWidgetBase::ShowLogin);
