...
void UNorthbreachGameInstance::Login(FString Email, FString Password)
{
	...
	ClientAPI->LoginWithEmailAddress(Request,
		PlayFab::UPlayFabClientAPI::FLoginWithEmailAddressDelegate::CreateUObject(this, &UNorthbreachGameInstance::OnLoginSuccess),
		PlayFab::FPlayFabErrorDelegate::CreateUObject(this, &UNorthbreachGameInstance::OnFail));
}

void UNorthbreachGameInstance::OnLoginSuccess(const PlayFab::ClientModels::FLoginResult& Result) const
{
